...
namespace TFTV
{
    internal class TFTVAAExperiment
    {
      ...
      //  public static bool KludgeCheck = false;
        ...
        internal static string actionExploring = "ENQUÊTE : ";
        ...
        internal static string actionAttack = "VA ATTAQUER :";
            internal static string actionAttackOnPX = "VA RÉALISER UNE ATTAQUE DE :";
            ...
            */
            ...
            private static string HoursToText(float hours)
            {
                ...
                {
                    DaysText = new LocalizedTextBind("{0}j", true),  // Calvitix Trad d -> j
