...
namespace TFTV.UIEnhancements
{
    internal static class ExtendedAgendaTracker
    {
        ...
        //internal static string actionAttack = "DEFEND {0} CONTRE {1}";
        ...
        */
        private static bool GetTravelTime(GeoVehicle vehicle, out float travelTime, GeoSite target = null)
        {
            ...
            //TFTVLogger.Info($"[ExtendedAgendaTracker_GetTravelTime] travelTime: {travelTime}");
        ...
        private static void AddAncientSiteEncounterObjective(/*UIStateVehicleSelected uiStateVehicleSelected, */GeoPhoenixFaction geoPhoenixFaction, SiteExcavationState excavatingSite)
        {
            ...
            {
                TFTVLogger.Info($"[AddAncientSiteEncounterObjective] Adding objective for mission: {excavatingSite.Site.ActiveMission?.MissionDef.Description.Localize()} at excavatingSite: {excavatingSite.Site.Name}");
        ...
        */
        ...
        public static class UIStateVehicleSelected_EnterState_Patch
        {
            ...
            {
                return true;// AssortedAdjustments.Settings.EnableExtendedAgendaTracker;
            }
            ...
            public static void Postfix(UIStateVehicleSelected __instance)
            {
                try
                {
                    if (___factionTracker == null)
                    {
                        ...
                        TFTVLogger.Info($"[UIStateVehicleSelected_EnterState_POSTFIX] Cached UIModuleFactionAgendaTracker");
                    }
        ...
        public static class GeoAlienFaction_StartPhoenixBaseAssault_Patch
        {
            ...
            public static bool Prefix(GeoAlienFaction __instance, SiteAttackSchedule target)
            {
                try
                {
                    TFTVLogger.Info($"[GeoAlienFaction_StartPhoenixBaseAssault_PREFIX] Base assault on {target.Site.Name} should start");
                    ...
                    {
                        TFTVLogger.Info($"[GeoAlienFaction_StartPhoenixBaseAssault_PREFIX] Original method would cancel the mission as there is no alien base in range left. Overriding. Starting mission NOW.");
                        //return;
                    }
        ...
        public static class UIModuleStatusBarMessages_Update_Patch
        {
            public static bool Prepare()
            {
                return true;// AssortedAdjustments.Settings.EnableExtendedAgendaTracker && AssortedAdjustments.Settings.AgendaTrackerHideStatusBar;
            }
        ...
        public static class GeoObjectiveElementController_SetObjective_Patch
        {
            public static bool Prepare()
            {
                return true;// AssortedAdjustments.Settings.EnableExtendedAgendaTracker && AssortedAdjustments.Settings.AgendaTrackerShowExcavations && AssortedAdjustments.Settings.AgendaTrackerAddMissionObjective;
            }
            ...
            public static void Prefix(GeoObjectiveElementController __instance, ref Sprite icon, ref Color iconColor)
            {
                try
                {
                    if (icon == null)
                    {
                        TFTVLogger.Info($"[GeoObjectiveElementController_SetObjective_PREFIX] Icon is null, setting a custom one.");
        ...
        public static class GeoSiteVisualsController_RefreshSiteVisuals_Patch
        {
            ...
            public static void Postfix(GeoSiteVisualsController __instance, GeoSite site)
            {
                try
                {
                    ...
                    {
                        TFTVLogger.Info($"[GeoSiteVisualsController_RefreshSiteVisuals_POSTFIX] Site: {site.Name} is scheduled for an attack.");

                        // Works
                        foreach (Renderer r in __instance.TimerController.gameObject.GetComponentsInChildren<Renderer>())
                        {
                            //TFTVLogger.Info($"{r.name}, {r.GetType()}");
        ...
        public static class UIModuleFactionAgendaTracker_Dispose_Patch
        {
            ...
            public static void Prefix(UIModuleFactionAgendaTracker __instance, UIFactionDataTrackerElement element)
            {
                try
                {
                    TFTVLogger.Info($"[UIModuleFactionAgendaTracker_Dispose_PREFIX] element.TrackedObject: {element.TrackedObject}");
        ...
        */
        ...
        //    public static bool Prepare()
        //    {
        //        return true;// AssortedAdjustments.Settings.EnableExtendedAgendaTracker && AssortedAdjustments.Settings.AgendaTrackerShowExcavations;
        //    }
        ...
        //            TFTVLogger.Info($"[GeoscapeLog_PhoenixFaction_OnExcavationStarted_POSTFIX] {faction.Name.Localize(null)} will excavate {excavation.Site.LocalizedSiteName}");
        ...
        public static class GeoscapeLog_ShowSiteDefenseTimer_Patch
        {
            public static bool Prepare()
            {
                return true;// AssortedAdjustments.Settings.EnableExtendedAgendaTracker && AssortedAdjustments.Settings.AgendaTrackerShowBaseDefenses;
            }
            ...
            public static void Postfix(GeoscapeLog __instance, GeoFaction faction, SiteAttackSchedule target)
            {
                try
                {
                    ...
                    TFTVLogger.Info($"[GeoscapeLog_ShowSiteDefenseTimer_POSTFIX] {faction.Name.Localize(null)} will attack {target.Site.LocalizedSiteName}");
        ...
        //    public static bool Prepare()
        //    {
        //        return true;// AssortedAdjustments.Settings.EnableExtendedAgendaTracker && AssortedAdjustments.Settings.AgendaTrackerShowVehicles;
        //    }
        ...
        //        try
        //        {
        //            TFTVLogger.Info($"[UIStateVehicleSelected_OnContextualItemSelected_POSTFIX] ability: {ability.AbilityDef.name}");
    ...
    //        public static bool Prepare()
    //        {
    //            return false;// AssortedAdjustments.Settings.EnableExtendedAgendaTracker && AssortedAdjustments.Settings.AgendaTrackerShowExcavations;
    //        }
    ...
    //                        //TFTVLogger.Info($"[UIModuleFactionAgendaTracker_UpdateData_PREFIX] element.TrackedObject: {element.TrackedObject}, arrivalTime: {arrivalTime}");
    ...
    //                        //TFTVLogger.Info($"[UIModuleFactionAgendaTracker_UpdateData_PREFIX] element.TrackedObject: {element.TrackedObject}, explorationTimeEnd: {explorationTimeEnd}");
    ...
    //                        //TFTVLogger.Info($"[UIModuleFactionAgendaTracker_UpdateData_PREFIX] element.TrackedObject: {element.TrackedObject}, repairsCarriedOut: {repairsCarriedOut}");
    ...
    //                                        //TFTVLogger.Info($"[UIModuleFactionAgendaTracker_UpdateData_PREFIX] element.TrackedObject: {element.TrackedObject}, attackTime: {attackTime}");
    ...
    //                            //TFTVLogger.Info($"[UIModuleFactionAgendaTracker_UpdateData_PREFIX] element.TrackedObject: {element.TrackedObject}, excavationTimeEnd: {excavationTimeEnd}");
