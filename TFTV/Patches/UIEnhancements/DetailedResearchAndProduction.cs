...
namespace TFTV.Patches.UIEnhancements
{
    internal static class DetailedResearchAndProduction
    {
        ...
        public static class ResearchListItem_SetTime_Patch
        {
            ...
            {
                return true;// AssortedAdjustments.Settings.EnableUIEnhancements && AssortedAdjustments.Settings.ShowDetailedResearchAndProduction;
            }
            ...
            public static void Postfix(ResearchListItem __instance, Text timeText)
            {
                try
                {
                    ...
                    TFTVLogger.Debug($"[ResearchListItem_SetTime_POSTFIX] itemResearchCost:  {itemResearchCost}");
                    ...
                    TFTVLogger.Debug($"[ResearchListItem_SetTime_POSTFIX] hourlyResearchProduction:  {hourlyResearchProduction}");
                    TFTVLogger.Debug($"[ResearchListItem_SetTime_POSTFIX] dailyResearchProduction:  {dailyResearchProduction}");
                    */
        ...
        public static class GeoManufactureItem_Init_Patch
        {
            ...
            public static void Postfix(GeoManufactureItem __instance, ItemDef item, GeoFaction faction, UIModuleManufacturing.UIMode mode)
            {
                try
                {
                    ...
                    //TFTVLogger.Info($"[GeoManufactureItem_Init_POSTFIX] itemManufactureCost:  {itemManufactureCost}");
        ...
        public static class UIModuleInfoBar_UpdateResourceInfo_Patch
        {
            ...
            public static void Postfix(UIModuleInfoBar __instance, GeoFaction faction)
            {
                try
                {
                    //TFTVLogger.Debug($"[UIModuleInfoBar_UpdateResourceInfo_POSTFIX] faction: {faction.Name.LocalizeEnglish()}");
                    ...
                    //TFTVLogger.Info($"[UIModuleInfoBar_UpdateResourceInfo_POSTFIX] totalResearch: {totalResearch}");
                    //TFTVLogger.Info($"[UIModuleInfoBar_UpdateResourceInfo_POSTFIX] totalProduction: {totalProduction}");
        ...
        public static class UITooltipText_OnMouseEnter_Patch
        {
            ...
            public static void Postfix(UITooltipText __instance, GameObject ____widget)
            {
                try
                {
                    ...
                    {
                        TFTVLogger.Debug($"[UITooltipText_OnMouseEnter_POSTFIX] TipKey: {__instance.TipKey.LocalizationKey}");
                        TFTVLogger.Debug($"[UITooltipText_OnMouseEnter_POSTFIX] TipText: {__instance.TipText}");
