    ...
    public class TFTVMain : ModMain
    {
        ...
        public override void OnModEnabled()
        {
            try
            {
                ...
                TFTVversion = $"TFTV 11-mars-2023 version Fr v{MetaData.Version}";

                Logger.LogInfo("TFTV 11-mars-2023 version Fr");
                ...
                // DefCache.Initialize();
                TFTVLogger.Always("TFTV 11 mars 2023 release FR#1");
